...
class SettingsService:
    ...
    async def get_all(self, user_id: str) -> AppSettings:
    ...
    async def get_group(self, user_id: str, group: str) -> dict[str, Any]:
        settings = await self.get_all(user_id)
        value = getattr(settings, group)
        return value.model_dump()

    async def update(self, user_id: str, group: str, payload: BaseModel) -> dict[str, Any]:
    ...
    async def reset(self, user_id: str) -> AppSettings:
    ...
    async def invalidate_recommendations(self, user_id: str) -> None:
